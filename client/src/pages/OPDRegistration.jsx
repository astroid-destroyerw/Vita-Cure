        ...
        <div className={`modal ${dark === 'dark' ? 'modal-dark' : ''}`}>
          <div className="modal-content">
            <div className="OpdHeader">
              <img src="/favicon.png" className="image" alt="Logo" style={{ width: '48px', height: '48px' }} />
              <p className="OPDText">Vita-Cure</p>
            </div>
            <hr></hr>
            ...
            >
              <hr />
              <p>&copy; 2024 Vita-Cure. All rights reserved. &trade;</p>
            </footer>
          </div>
        </div>
      )}
