...
const Footer = () => {
 ...
 const [dark, setDark] = useRecoilState(mode);
  ...
  const socialMedia = [
    {
      Icon: FaGithub,
      link: 'https://github.com/Luson045/vitacure',
      color: '#333',
    },
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-between space-x-4">
          ...
          <div className="space-y-4 w-full md:w-auto">
            ...
            >
              ...
              />
              <span className="text-3xl font-bold bg-gradient-to-r from-[#1f2937] to-[#b6dbfc] bg-clip-text text-transparent group-hover:from-[#133859] group-hover:to-[#b6dbfc] transition-all duration-300">
                Vita-Cure
              </span>
            </Link>
            <p className="text-sm leading-relaxed max-w-xs">
              The Vita-Cure platform simplifies hospital management with
        ...
        <div className="mt-8 pt-8 border-t border-[#b6dbfc]/30 text-center">
          ...
          className={`${
            ...
            "The information provided on Vita-Cure is intended for general
            ...
            treatment. Vita-Cure facilitates OPD appointment booking and
